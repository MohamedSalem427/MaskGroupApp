...
public extension UIView {
    ...
    */
    ...
    func makeToastActivity(_ position: ToastPosition ,
                           activityBackgroundColor: UIColor = UIColor.black.withAlphaComponent(0.8),
        ...
        let toast = createToastActivityView(activityBackgroundColor: activityBackgroundColor,
    ...
    private func createToastActivityView(activityBackgroundColor: UIColor = UIColor.black.withAlphaComponent(0.8),
                                         activityIndicatorColor:UIColor = .white) -> UIView {
        let style = ToastManager.shared.style

        let activityView = UIView(frame: CGRect(x: 0.0, y: 0.0, width: style.activitySize.width, height: style.activitySize.height))
        activityView.backgroundColor = activityBackgroundColor
